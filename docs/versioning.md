...
1. **GitHub Releases page**: `https://github.com/verdantstack/sveltekit-supabase-starter/releases`
   - Each release has a tag (e.g. `v0.2.3`) and release notes from `CHANGELOG.md`.
2. **Clone a specific tag**:
   ```bash
   git clone --branch v0.2.3 https://github.com/verdantstack/sveltekit-supabase-starter.git
   ```
3. **Download a specific version**:
   ```bash
   curl -L https://github.com/verdantstack/sveltekit-supabase-starter/archive/refs/tags/v0.2.3.zip -o starter-v0.2.3.zip
   ```

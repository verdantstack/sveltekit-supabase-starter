...
**Version**: 0.2.3 | **Last Updated**: 2026-09-08 | **License**: Proprietary

[![Changelog](https://img.shields.io/badge/changelog-CHANGELOG.md-blue)](CHANGELOG.md)
[![Version](https://img.shields.io/badge/version-0.2.3-green)](https://github.com/verdantstack/sveltekit-supabase-starter/releases)
...
- [x] Tests: 208 tests — service-level (fake Supabase) + smoke, covering RBAC, orgs, invites, billing, audit
...
| ![208 tests passing](docs/screenshots/S6-vitest-208-passed.png) | Verbatim `npm test` output — 208 passing |

...
**Version**: 0.1.0 | **Last Updated**: 2026-08-29 | **License**: Proprietary

[![Changelog](https://img.shields.io/badge/changelog-CHANGELOG.md-blue)](CHANGELOG.md)
[![Version](https://img.shields.io/badge/version-0.1.0-green)](https://github.com/verdantstack/sveltekit-supabase-starter/releases)
...
- [x] Tests: comprehensive test suite covering auth, RBAC, invites, billing
...
- **Framework:** Vitest
- **Database:** Supabase (test project or local via `supabase start`)
- **Run:** `npm test`

### Test Files
| File | Coverage |
|------|----------|
| `tests/auth.test.ts` | Supabase Auth lifecycle |

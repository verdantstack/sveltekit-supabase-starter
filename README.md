...
**Version**: 0.2.5 | Last Updated: 2026-09-13 | **License**: Proprietary

[![Changelog](https://img.shields.io/badge/changelog-CHANGELOG.md-blue)](CHANGELOG.md)
[![Version](https://img.shields.io/badge/version-0.2.5-green)](https://github.com/verdantstack/sveltekit-supabase-starter/releases)
...
- [x] Tests: 310 tests — service-level (fake Supabase) + smoke, covering RBAC, orgs, invites, billing, audit
...
| ![310 tests passing](docs/screenshots/S6-vitest-310-passed.png)                                | Verbatim `npm test` output — 310 passing         |

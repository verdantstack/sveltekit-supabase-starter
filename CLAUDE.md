...
A production-grade B2B SaaS foundation for SvelteKit + Supabase. Not a tutorial, not a boilerplate — a working implementation of multi-tenancy, RBAC, seat billing, audit logging, and Supabase RLS with 208 tests.
...
- RBAC / org / member / invite / billing / audit suites (208 tests) prove the business rules

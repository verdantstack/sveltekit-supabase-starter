...
A production-grade B2B SaaS foundation for SvelteKit + Supabase. Not a tutorial, not a boilerplate — a working implementation of multi-tenancy, RBAC, seat billing, audit logging, and Supabase RLS with comprehensive tests.
...
- Tests exercise services directly
- The RBAC tests prove the permission matrix is correct
- Smoke tests verify the build and basic integration
- For full HTTP-level testing, a running Supabase instance is needed
